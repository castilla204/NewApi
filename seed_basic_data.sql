...
VALUES
  ...
  (3, 'Llamada', 'Llamada telefónica', 'Llamada para explicarte el informe y resolver dudas.', FALSE, TRUE, 3, NOW(), NOW())
ON CONFLICT ("Id") DO NOTHING;

SELECT setval(pg_get_serial_sequence('"DeliverableTypes"', 'Id'), GREATEST((SELECT MAX("Id") FROM "DeliverableTypes"), 3));
