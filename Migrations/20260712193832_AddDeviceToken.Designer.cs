...
namespace newApi.Migrations
{
    ...
    [Migration("20260712193832_AddDeviceToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.Appointment", b =>
                {
                    ...
                    b.HasIndex("ExpertId", "StartsAtUtc")
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.DeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.ExpertAvailabilityException", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ExpertId", "Date");

                    b.ToTable("ExpertAvailabilityExceptions");
                });

            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.ExpertAvailabilityRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ExpertAvailabilityRules");
                });
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.ExpertProfile", b =>
                {
                    ...
                    b.Property<string>("WorkLocationDoor")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");

                    b.Property<string>("WorkLocationFloor")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.Review", b =>
                {
                    ...
                    b.HasIndex("ReviewerId", "ExpertId", "SearchHireId")
                        .IsUnique()
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.SearchHire", b =>
                {
                    ...
                    b.Property<int?>("DurationInHoursSnapshot")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ExpertLatitudeSnapshot")
                        .HasColumnType("text");

                    b.Property<string>("ExpertLongitudeSnapshot")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ExpertWorkLocationDetailsSnapshot")
                        .HasColumnType("text");

                    b.Property<string>("ExpertWorkLocationDoorSnapshot")
                        .HasColumnType("text");

                    b.Property<string>("ExpertWorkLocationFloorSnapshot")
                        .HasColumnType("text");

                    b.Property<int?>("ExpertWorkRadiusKmSnapshot")
                        .HasColumnType("integer");

                    b.Property<string>("InspectionTemplatePdfUrlSnapshot")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("SellerBookingDeadline")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("SellerBookingMaxDays")
                        .HasColumnType("integer");

                    b.Property<string>("SellerBookingToken")
                        .HasColumnType("text");

                    b.Property<string>("SellerEmail")
                        .HasColumnType("text");

                    b.Property<string>("SellerListingUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.SearchService", b =>
                {
                    ...
                    b.Property<string>("InspectionTemplateConfig")
                        .HasColumnType("text");

                    b.Property<string>("InspectionTemplatePdfUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.SystemSetting", b =>
                {
                    ...
                    b.Property<int>("CancellationTierHighHours")
                        .HasColumnType("integer");

                    b.Property<int>("CancellationTierLowHours")
                        .HasColumnType("integer");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("FreeCancellationsPerParty")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PenaltyFreeWindowDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("newApi.DataLayer.Models.PostGresModels.User", b =>
                {
                    ...
                    b.Property<string>("PhoneLineType")
                        .HasColumnType("text");

                    b.Property<string>("PhoneNumber")
                        .HasColumnType("text");

                    b.Property<string>("PhoneVerificationSource")
                        .HasColumnType("text");
