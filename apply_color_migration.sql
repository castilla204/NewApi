-- Aplicar migración para agregar campo Color a SystemStatuses
ALTER TABLE "SystemStatuses" ADD COLUMN "Color" character varying(20);

-- Actualizar los estados existentes con colores apropiados
