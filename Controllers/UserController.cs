...
public class UserController : ControllerBase
{
    ...
    */
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // 🛡️ Round 28 MUD-E: Wizard de mudanza self-service del experto.
    //
    ...
    {
        private readonly newApi.Services.ExpertRelocationService _service;
        private readonly ILoggingService _loggingService;

        public ExpertRelocationController(
            newApi.Services.ExpertRelocationService service,
            ILoggingService loggingService)
        {
            _service = service;
            _loggingService = loggingService;
